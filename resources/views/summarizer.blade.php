...
<body class="antialiased">
    <div
        class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-gray-800 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="pt-4">
                <p
                    class="text-center dark:text-white bg-center bg-gray-100 dark:bg-gray-900 selection:bg-[#268772] selection:text-white ">
            ...
            <form id="summary-form" action="{{ route('summary') }}" method="post">
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-2 md:grid-cols-2 gap-4">
                        ...
                        <div class="grid grid-row-2 md:grid-cols-1">
                            <div
                                class="p-4 bg-[#268772] dark:bg-[#268772] rounded-tl-lg rounded-tr-lg text-center gap-4 text-white select-none">
                                Summarized Text
                            </div>
                            <textarea
                                class="bg-white p-6 dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-br-lg rounded-bl-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500 dark:text-white block w-full resize-none overflow-y-auto selection:bg-[#268772]"
                                style="height: 491px" id="mySummarizedTextarea"></textarea>
                            <p class="text-right dark:text-white" id="summarizedWordCount"></p>
                        </div>
                    </div>
                </div>
                <div class="flex justify-center">
                ...
                $(document).ready(function() {
                    $('#summary-form').submit(function(event) {
                        ...
                        function updateWordCount(textareaId, countElementId) {
                            ...
                            var words = textarea.val().trim().split(/\s+/);
                            var wordCount = words.length;

                            countElement.text('Summarized Word Count: ' + wordCount);
                        }
